<html>
    <head>
        ...
        <title>SPARQL LabelingSystem Query</title>
        <style type="text/css">
    ...
    <body>
        ...
        <h1>SPARQL LabelingSystem Query</h1>
        <span id="example">
            <b>Example SPARQL-Querys: </b>
            <a href="javaScript:ex0()">SELECT all</a> |
            <a href="javaScript:ex1()">SELECT all projects</a> | 
            <a href="javaScript:ex2()">SELECT all vocabularies</a> | 
            <a href="javaScript:ex3()">SELECT all labels</a>
        </span>
        <br><br>
