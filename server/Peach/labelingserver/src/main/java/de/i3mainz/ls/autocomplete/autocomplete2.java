...
/**
 * SERVLET autocomplete for labels without connection to a vocabulary
 *
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (substing.length() <= 1) {
				...
				if (creator != null) { // creator filter
					query = "SELECT ?labelIdentifier ?prefLabels ?altLabels ?label ?creator ?prefLang WHERE { "
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Logger.getLogger(autocomplete2.class.getName()).log(Level.SEVERE, null, ex);
	...
	public String getServletInfo() {
		return "Autocomplete for labels without connection to a vocabulary";
	}// </editor-fold>
