 ...
 * @version 04.02.2015
 */
public class SPARQLconcepts extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if (format.equals("html")) {
				...
				SesameConnect.SPARQLqueryOutputFile("concepts", query, format, out);
			}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Logger.getLogger(SPARQLconcepts.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
	...
	public String getServletInfo() {
		return "Servlet returns SPARQL XML/JSON/CSV/TSV from triplestore (repository concepts)";
	}// </editor-fold>
