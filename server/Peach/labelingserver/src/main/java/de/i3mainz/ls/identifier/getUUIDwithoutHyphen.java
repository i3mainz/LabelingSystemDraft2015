...
/**
 * SERVLET returns UUIID without a hyphen
 *
 * @author Florian Thiery M.Sc.
 * @author i3mainz - Institute for Spatial Information and Surveying Technology
 * @version 05.02.2015
 */
public class getUUIDwithoutHyphen extends HttpServlet {

	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, UniqueIdentifierException {
		PrintWriter out = response.getWriter();
		try {
			out.print(UniqueIdentifier.getUUIDwithoutHyphen());
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Logger.getLogger(getUUIDwithoutHyphen.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
	...
	public String getServletInfo() {
		return "Servlet returns UUIID without a hyphen";
	}// </editor-fold>
