...
/**
 * SERVLET returns Project-Tree JSON object for published vocabularies
 *
 * @author Florian Thiery M.Sc.
 * @author i3mainz - Institute for Spatial Information and Surveying Technology
 * @version 06.02.2015
 */
public class getProjectTreeConceptsPublic extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Logger.getLogger(getProjectTreeConceptsPublic.class.getName()).log(Level.SEVERE, null, ex);
